...
void Configuration::checkConfig() {
	if (_config.empty() || _config.find("server.port") == _config.end()
		|| _config.find("server.pass") == _config.end()
		|| _config.find("server.ip") == _config.end()
		|| _config.find("bot.nick") == _config.end()
		|| _config.find("bot.nick") == _config.end()
		|| _config.find("bot.username") == _config.end()
		|| _config.find("bot.realname") == _config.end()) {
